    ...
    <div className="pt-20 min-h-screen bg-industrial-900 text-slate-50 font-sans">
      ...
      <div className="relative py-24 md:py-32 border-b border-industrial-800 bg-industrial-900 overflow-hidden">
         ...
         <div className="relative max-w-7xl mx-auto px-6 text-center z-10">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 tracking-tight drop-shadow-xl">联系我们</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {/* Contact Info Card */}
          <div className="bg-industrial-800 p-10 rounded-2xl border-l-4 border-industrial-accent flex flex-col justify-between h-fit shadow-2xl">
            <div>
              <h2 className="text-3xl font-bold text-white mb-10 tracking-tight">联系方式</h2>
              
              <div className="space-y-10">
                <div className="flex items-start gap-6">
                  <div className="w-14 h-14 bg-industrial-900 rounded-xl flex items-center justify-center text-industrial-accent flex-shrink-0 shadow-inner">
                    <Icons.Phone size={28} />
                  </div>
                  <div>
                    <h3 className="text-white font-bold mb-1 text-lg">24小时服务热线</h3>
                    <p className="text-3xl text-industrial-accent font-mono font-bold tracking-tight">{PHONE_NUMBER}</p>
                    <p className="text-sm text-gray-500 mt-2 font-medium">紧急救援 / 业务咨询 / 投诉建议</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-white font-bold mb-2 text-lg">公司地址</h3>
                    <MapAddress className="text-gray-300 text-lg leading-relaxed block hover:text-white transition-colors" />
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-white font-bold mb-1 text-lg">电子邮箱</h3>
            ...
            <div className="mt-16 pt-10 border-t border-industrial-700">
              <h3 className="text-white font-bold mb-8 flex items-center gap-3">
                关注官方账号 <span className="text-xs font-normal text-gray-400 px-2 py-1 bg-industrial-900 rounded border border-industrial-700">获取最新资讯</span>
              </h3>
              <div className="flex flex-row gap-8">
                <div className="flex flex-col items-center gap-3 group cursor-pointer">
                  <div className="p-2 bg-white rounded-xl shadow-lg group-hover:scale-105 transition-transform duration-300">
                    <img src={WECHAT_QR_IMAGE} alt="微信公众号" className="w-28 h-28" />
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-400 group-hover:text-green-500 transition-colors font-bold">
                ...
                <div className="flex flex-col items-center gap-3 group cursor-pointer">
                  <div className="p-2 bg-white rounded-xl shadow-lg group-hover:scale-105 transition-transform duration-300">
                    <img src={DOUYIN_QR_IMAGE} alt="抖音官方号" className="w-28 h-28" />
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-400 group-hover:text-white transition-colors font-bold">
          ...
          {/* Contact Form */}
          <div id="online-message" className="bg-industrial-800 p-10 rounded-2xl border border-industrial-700 relative overflow-hidden scroll-mt-24 shadow-2xl">
            <h2 className="text-3xl font-bold text-white mb-8 tracking-tight">在线留言</h2>
            ...
            {isSuccess ? (
              ...
              <form className="space-y-8" onSubmit={handleInitialSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <input 
                      ...
                      className={`w-full bg-industrial-900 border rounded-lg p-4 text-white focus:outline-none focus:ring-1 transition-colors text-lg ${
                        errors.name 
                          ? 'border-red-500 focus:border-red-500 focus:ring-red-500' 
                          : 'border-industrial-700 focus:border-industrial-accent focus:ring-industrial-accent'
                      }`}
                      placeholder="先生/女士" 
                    />
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-400 mb-3 uppercase tracking-wider">需求类型</label>
                  <select 
                    name="type"
                    value={formData.type}
                    onChange={handleInputChange}
                    className="w-full bg-industrial-900 border border-industrial-700 rounded-lg p-4 text-white focus:outline-none focus:border-industrial-accent text-lg appearance-none"
                  >
                    <option>维保报价</option>
                    <option>改造报价</option>
                    <option>购买新梯</option>
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-400 mb-3 uppercase tracking-wider">详细内容</label>
                  <textarea 
                    name="message"
                    value={formData.message}
                    onChange={handleInputChange}
                    rows={5} 
                    className="w-full bg-industrial-900 border border-industrial-700 rounded-lg p-4 text-white focus:outline-none focus:border-industrial-accent focus:ring-1 focus:ring-industrial-accent text-lg leading-relaxed" 
                ...
                <button 
                  ...
                  className="w-full bg-industrial-accent hover:bg-industrial-accentHover disabled:bg-industrial-700 disabled:cursor-not-allowed text-white font-bold py-5 rounded-lg transition-colors uppercase tracking-widest text-lg flex items-center justify-center gap-3 shadow-lg hover:shadow-orange-500/20"
                >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-industrial-800 border border-industrial-600 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="bg-industrial-900 rounded-xl p-6 space-y-4 text-base border border-industrial-700">
                ...
                {formData.message && (
                  <div className="pt-2 border-t border-industrial-800 mt-2">
                    <span className="block text-gray-500 mb-2 text-sm">详细内容</span>
                    <span className="text-gray-300 block bg-industrial-800/50 p-3 rounded-lg text-sm">{formData.message}</span>
                  </div>
                )}
              </div>
            </div>
