...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO 
        title="东莞博升电梯 - 专业电梯维保、销售、安装服务" 
        description="博升电梯提供东莞地区电梯维保、电梯销售、维修安装一站式服务。安全可靠，24小时响应，拥有特种设备安装改造维修资质。联系电话：13360672276。"
        keywords={['东莞电梯', '东莞电梯维保', '电梯维修公司', '电梯安装', '老旧梯改造', '博升电梯', '电梯保养']}
        schema={homeSchema}
      />
